...
// Get all beneficiaries (filtered by NGO if user is ngo_admin)
$beneficiaries = [];
$query = "SELECT b.id, b.full_name, b.age, b.sex, 
         b.contact_number, b.address, b.notes
         FROM beneficiaries b";

if ($_SESSION['user_type'] === 'ngo_admin') {
    $query .= " WHERE b.ngo_id = " . $_SESSION['user_id'];
}

$query .= " ORDER BY b.full_name ASC";
...
<head>
    ...
    <title>Beneficiaries | FoodSave</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4 dashboard-header-row">
            <div class="d-flex align-items-center header-left">
                ...
                <span class="header-welcome">Beneficiaries</span>
            </div>
            <div class="d-flex align-items-center header-right">
                ...
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBeneficiaryModal">
            ...
            <div class="card-body">
                <?php if (empty($beneficiaries)): ?>
                    <div class="empty-state">
                        ...
                        <p class="text-muted">There are currently no beneficiaries in the system.</p>
                        <button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#addBeneficiaryModal">
                                ...
                                <tr>
                                    <td>
                                        <div class="beneficiary-photo">
                                            <?php echo strtoupper(substr($beneficiary['full_name'], 0, 1)); ?>
                                        </div>
                                    </td>
                                    <td><?php echo htmlspecialchars($beneficiary['full_name']); ?></td>
                                    <td><?php echo $beneficiary['age']; ?></td>
                                    <td><?php echo htmlspecialchars($beneficiary['sex']); ?></td>
                                    <td><?php echo htmlspecialchars($beneficiary['contact_number']); ?></td>
                                    <td>
    ...
    <div class="mobile-navbar">
        ...
        <a href="beneficiaries.php" class="mobile-nav-item active">
            <i class="fas fa-users"></i>
